            ...
            <div class="col-lg-8">
                ...
                <div class="vote-card p-4 mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h3>About <?php echo htmlspecialchars($nominee['name']); ?></h3>
                    ...
                    <?php if (!empty($relatedNominees)): ?>
                        <div class="list-group">
                            <?php foreach ($relatedNominees as $related): ?>
                                <a href="vote.php?id=<?php echo $related['id']; ?>" class="list-group-item list-group-item-action">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <small><?php echo render_country_flag($related['id']) . ' ' . htmlspecialchars($related['country_name']); ?></small>
                                        </div>
                                        <?php 
